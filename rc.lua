...
globalkeys = my_table.join(
    ...
    awful.key({ modkey }, "d", function () awful.spawn("idaq64") end,
              {description = "run ida pro 64", group = "launcher"}),
    -- Default
    --[[ Menubar
...
awful.rules.rules = {
    ...
    --{ rule = { class = "Firefox" },
    { rule = { class = "Chromium" },
      properties = { opacity = 1, maximized = false, floating = false, maximized_vertical = false, maximized_horizontal = false } },
